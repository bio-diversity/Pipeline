...
Additionally, to focus on consistently observed species, the dataset is further filtered to retain only those with ≥10 cumulative detections across all confidence levels. This ensures that rare or noise-level detections do not bias downstream summaries and visualizations.
